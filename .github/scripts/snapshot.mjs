...
// 1. Fetch the Top 100 clan summaries from leaderboard
const summaries = [];
...
// 2. Fetch full roster + point contributions for each clan
...
// 3. Resolve numeric display names
let resolvedCache = {};
